...
import {
  InfluenceService,
  RecentActivity,
} from '../../service/influence.service';
...
export class RecentActivityComponent implements OnInit, OnDestroy {
  ...
  fetchActivities(): void {
    ...
    const fallbackData: RecentActivity[] = [
      {
        message: 'Redawan just booked Complete Package of New Zealand Travel',
        time_ago: '19 minutes ago',
      },
      {
        message: "Motaleb H. just booked Grand Package to cox's bazer (23 Feb)",
        time_ago: '1 month ago',
      },
      {
        message: "Redawan just booked Grand Package to cox's bazer (23 Feb)",
        time_ago: '1 month ago',
      },
      {
        message: "Sotez just booked Grand Package to cox's bazer testing",
        time_ago: '1 month ago',
      },
      {
        message: "Abir S. just booked Grand Package to cox's bazer testing",
        time_ago: '1 month ago',
      },
    ];
